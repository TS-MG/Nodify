Contributing to Nodify Core
============================

The Nodify Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nodify Core project, and is not to be
confused with overall Nodify Network Protocol consensus changes.

Whether a pull request is merged into Nodify Core rests with the project merge
...
Patches that change Nodify consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nodify consensus, it must have been
...
The project leader is the release manager for each Nodify Core release.
