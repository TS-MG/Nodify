...
RESOURCES += src/qt/nodify.qrc src/qt/nodify_locale.qrc

TRANSLATIONS += src/qt/locale/nodify_bg.ts \
                src/qt/locale/nodify_de.ts \
                src/qt/locale/nodify_en.ts \
                src/qt/locale/nodify_es.ts \
                src/qt/locale/nodify_fi.ts \
                src/qt/locale/nodify_fr.ts \
                src/qt/locale/nodify_it.ts \
                src/qt/locale/nodify_ja.ts \
                src/qt/locale/nodify_pl.ts \
                src/qt/locale/nodify_pt.ts \
                src/qt/locale/nodify_ru.ts \
                src/qt/locale/nodify_sk.ts \
                src/qt/locale/nodify_sv.ts \
                src/qt/locale/nodify_vi.ts \
                src/qt/locale/nodify_zh_CN.ts \
                src/qt/locale/nodify_zh_TW.ts
