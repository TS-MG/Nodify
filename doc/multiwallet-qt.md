...
In order to support loading of multiple wallets in nodify-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodify.cpp.
...
Changes to nodify.cpp
----------------------
nodify.cpp is the entry point into nodify-qt, and as such, will require some minor modifications to provide hooks for
