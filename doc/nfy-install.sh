...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='nodify.conf'
CONFIGFOLDER='/root/.nodify'
COIN_DAEMON='nodifyd'
COIN_CLI='nodify-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/MartinWenskus/MN/raw/master/nfy-core.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='nodify'
COIN_EXPLORER='http://45.77.56.105:88/'
COIN_PORT=12112
RPC_PORT=12113
...
cat << EOF >> $CONFIGFOLDER/masternode.conf

#mn0 $NODEIP:$COIN_PORT $COINKEY
EOF
...
apt-get install -y nodejs-legacy npm >/dev/null 2>&1
...
function important_information() {
 ...
 echo -e "MN Entry: ${GREEN}$NODEIP:$COIN_PORT $COINKEY${NC}"
