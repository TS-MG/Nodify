...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Nodify features */
        {"nodify", "masternode", &masternode, true, true, false},
        {"nodify", "listmasternodes", &listmasternodes, true, true, false},
        {"nodify", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nodify", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nodify", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nodify", "masternodedebug", &masternodedebug, true, true, false},
        {"nodify", "startmasternode", &startmasternode, true, true, false},
        {"nodify", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nodify", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nodify", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nodify", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nodify", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nodify", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nodify", "mnbudget", &mnbudget, true, true, false},
        {"nodify", "preparebudget", &preparebudget, true, true, false},
        {"nodify", "submitbudget", &submitbudget, true, true, false},
        {"nodify", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nodify", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nodify", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nodify", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nodify", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nodify", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nodify", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nodify", "checkbudgets", &checkbudgets, true, true, false},
        {"nodify", "mnsync", &mnsync, true, true, false},
        {"nodify", "spork", &spork, true, true, false},
        {"nodify", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"nodify", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use nodifyd, or the -server option to nodify-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> nodify-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:13113/\n";
}
