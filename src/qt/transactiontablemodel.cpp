...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Nodify to zNodify");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zNodify");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Nodify from zNodify");
    case TransactionRecord::ZerocoinSpend_Change_zNodify:
        return tr("Minted Change as zNodify from zNodify Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zNodify to Nodify");
