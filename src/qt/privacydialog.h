...
public:
    ...
    void setZNodifyControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzNFY_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzNFY_clicked();
    void on_pushButtonZNodifyControl_clicked();
