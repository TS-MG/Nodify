                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Nodify from zNodify"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zNodify"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zNodify));
