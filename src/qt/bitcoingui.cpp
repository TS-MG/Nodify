                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Nodify Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nodify address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodify: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNFY"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Nodify Core"), this);
    aboutAction->setStatusTip(tr("Show information about Nodify Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Nodify"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nodify addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nodify addresses"));
    ...
    openAction->setStatusTip(tr("Open a Nodify: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Nodify Core help message to get a list with possible Nodify command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Nodify Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nodify network", "", count));
}
...
{
    QString strTitle = tr("Nodify Core"); // default title
...
/** Creates context menu, its actions, and nodifys up all the relevant signals for mouse events. */
