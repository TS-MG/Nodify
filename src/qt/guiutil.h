...
/** Utility functions used by the Nodify Qt UI.
 */
namespace GUIUtil
{
...
// Render Nodify addresses in monospace font
...
// Parse "nodify:" URI into recipient object, return true on successful parsing
